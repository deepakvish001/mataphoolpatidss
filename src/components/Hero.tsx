import { ArrowRight, Play, Award, Users, BookOpen, Target, TrendingUp, Star, Sparkles, Zap, Trophy } from 'lucide-react';
    ...
    <section id="home" className="relative min-h-screen hero-gradient overflow-hidden">
      ...
      <div className="absolute inset-0">
        ...
        <div className="absolute top-0 right-0 w-1/2 h-full">
          <div className="absolute top-1/4 right-1/4 w-96 h-96 bg-primary/10 rotate-45 rounded-3xl animate-float shadow-colorful"></div>
          <div className="absolute top-1/2 right-1/6 w-64 h-64 bg-accent/10 rotate-12 rounded-2xl animate-float" style={{animationDelay: '1s'}}></div>
          <div className="absolute bottom-1/4 right-1/3 w-48 h-48 bg-secondary/10 -rotate-12 rounded-xl animate-float" style={{animationDelay: '2s'}}></div>
          <div className="absolute top-1/3 right-1/2 w-32 h-32 bg-orange/10 rotate-45 rounded-lg animate-float" style={{animationDelay: '3s'}}></div>
        </div>
        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center w-full">
          ...
          <div className="space-y-8 lg:pr-8">
            ...
            <div className="flex items-start">
              <Badge variant="secondary" className="button-gradient text-primary-foreground border-none px-6 py-3 text-sm font-semibold rounded-full shadow-lg">
            ...
            <div className="space-y-4 sm:space-y-6">
              <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-black leading-tight">
                ...
                <span className="text-gradient-enhanced block">CAREERS</span>
            ...
            <div className="pt-8">
              <div className="warm-gradient backdrop-blur-sm rounded-2xl p-6 shadow-colorful border border-border/20">
                <h3 className="text-sm font-semibold text-orange-foreground mb-4 text-center">TRUSTED BY THOUSANDS</h3>
                <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
                  <div className="flex flex-col items-center text-center space-y-2">
                    <div className="w-12 h-12 bg-primary/20 rounded-xl flex items-center justify-center shadow-lg">
                      <BookOpen className="h-6 w-6 text-primary" />
                    </div>
                    <span className="text-xs font-medium text-orange-foreground">NSDC Certified</span>
                  </div>
                  <div className="flex flex-col items-center text-center space-y-2">
                    <div className="w-12 h-12 bg-accent/20 rounded-xl flex items-center justify-center shadow-lg">
                      <Users className="h-6 w-6 text-accent" />
                    </div>
                    <span className="text-xs font-medium text-orange-foreground">Pan India Network</span>
                  </div>
                  <div className="flex flex-col items-center text-center space-y-2">
                    <div className="w-12 h-12 bg-secondary/20 rounded-xl flex items-center justify-center shadow-lg">
                      <Trophy className="h-6 w-6 text-secondary" />
                    </div>
                    <span className="text-xs font-medium text-orange-foreground">Government Approved</span>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div className="relative mt-8 lg:mt-0 lg:block">
            ...
            <div className="relative mx-4 sm:mx-6 lg:mx-8">
              <div className="aspect-[4/5] sm:aspect-[3/4] lg:aspect-[4/5] rounded-2xl sm:rounded-3xl overflow-hidden accent-gradient p-4 sm:p-6 shadow-colorful">
                <img 
                  src={heroImage} 
              ...
              <div className="absolute -top-8 -right-12 card-premium w-48 shadow-colorful">
                <div className="flex items-center space-x-3">
                  <div className="w-10 h-10 button-gradient rounded-lg flex items-center justify-center flex-shrink-0">
              ...
              <div className="absolute -bottom-4 -left-8 card-premium w-48 shadow-colorful">
                <div className="flex items-center space-x-3">
