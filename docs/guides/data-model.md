...
This guide defines the foundation data model for **Samarth Shakti Foundation Platform**, a skill-development programmes and protected foundation administration application.

## Scope

The guidance covers programmes, courses, schemes, partners, donations, attendance and content. It applies to new features, maintenance changes and production operations.
