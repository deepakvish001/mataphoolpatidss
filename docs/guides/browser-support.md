...
This guide defines the browser support for **Samarth Shakti Foundation Platform**, a skill-development programmes and protected foundation administration application.

## Scope

The guidance covers supported devices, responsive layouts and progressive enhancement. It applies to new features, maintenance changes and production operations.
