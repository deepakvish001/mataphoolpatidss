...
This guide defines the error handling for **Samarth Shakti Foundation Platform**, a skill-development programmes and protected foundation administration application.

## Scope

The guidance covers form validation, network errors, provider outages and safe recovery. It applies to new features, maintenance changes and production operations.
