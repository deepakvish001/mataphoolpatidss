...
This guide defines the security baseline for **Samarth Shakti Foundation Platform**, a skill-development programmes and protected foundation administration application.

## Scope

The guidance covers personal data, donation safety, uploads, policies and dependency security. It applies to new features, maintenance changes and production operations.
