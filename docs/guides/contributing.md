...
This guide defines the contribution workflow for **Samarth Shakti Foundation Platform**, a skill-development programmes and protected foundation administration application.

## Scope

The guidance covers branching, validation, screenshots, migrations and review expectations. It applies to new features, maintenance changes and production operations.
