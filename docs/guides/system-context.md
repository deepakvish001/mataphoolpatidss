...
This guide defines the system context for **Samarth Shakti Foundation Platform**, a skill-development programmes and protected foundation administration application.

## Scope

The guidance covers public visitors, learners, donors, staff, administrators and external services. It applies to new features, maintenance changes and production operations.
