...
This guide defines the release process for **Samarth Shakti Foundation Platform**, a skill-development programmes and protected foundation administration application.

## Scope

The guidance covers versioning, content review, database checks and rollback ownership. It applies to new features, maintenance changes and production operations.
