...
This guide defines the local development workflow for **Samarth Shakti Foundation Platform**, a skill-development programmes and protected foundation administration application.

## Scope

The guidance covers installation, startup, testing, debugging and common recovery steps. It applies to new features, maintenance changes and production operations.
