...
This guide defines the troubleshooting handbook for **Samarth Shakti Foundation Platform**, a skill-development programmes and protected foundation administration application.

## Scope

The guidance covers Vite, Supabase, authentication, tests, reports and production builds. It applies to new features, maintenance changes and production operations.
