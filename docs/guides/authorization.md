...
This guide defines the authorization model for **Samarth Shakti Foundation Platform**, a skill-development programmes and protected foundation administration application.

## Scope

The guidance covers public access, staff capabilities, admin privileges and database enforcement. It applies to new features, maintenance changes and production operations.
