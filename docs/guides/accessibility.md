...
This guide defines the accessibility standard for **Samarth Shakti Foundation Platform**, a skill-development programmes and protected foundation administration application.

## Scope

The guidance covers navigation, forms, errors, language, colour, motion and assistive technology. It applies to new features, maintenance changes and production operations.
