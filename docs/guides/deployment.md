...
This guide defines the deployment guide for **Samarth Shakti Foundation Platform**, a skill-development programmes and protected foundation administration application.

## Scope

The guidance covers build, environment injection, SPA routing, verification and rollback. It applies to new features, maintenance changes and production operations.
