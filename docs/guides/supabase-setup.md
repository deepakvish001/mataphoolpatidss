...
This guide defines the supabase setup for **Samarth Shakti Foundation Platform**, a skill-development programmes and protected foundation administration application.

## Scope

The guidance covers project creation, authentication, schema, policies and environment configuration. It applies to new features, maintenance changes and production operations.
