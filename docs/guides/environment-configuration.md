...
This guide defines the environment configuration for **Samarth Shakti Foundation Platform**, a skill-development programmes and protected foundation administration application.

## Scope

The guidance covers public client variables, secret boundaries and deployment overrides. It applies to new features, maintenance changes and production operations.
