...
This guide defines the observability design for **Samarth Shakti Foundation Platform**, a skill-development programmes and protected foundation administration application.

## Scope

The guidance covers availability, form failures, authentication, database latency and background tasks. It applies to new features, maintenance changes and production operations.
