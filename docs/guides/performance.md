...
This guide defines the performance budget for **Samarth Shakti Foundation Platform**, a skill-development programmes and protected foundation administration application.

## Scope

The guidance covers landing page media, admin tables, queries, reports and bundle size. It applies to new features, maintenance changes and production operations.
