...
This guide defines the logging guidance for **Samarth Shakti Foundation Platform**, a skill-development programmes and protected foundation administration application.

## Scope

The guidance covers structured events, personal-data redaction, retention and administrative investigations. It applies to new features, maintenance changes and production operations.
