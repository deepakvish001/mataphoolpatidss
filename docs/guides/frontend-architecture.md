...
This guide defines the frontend architecture for **Samarth Shakti Foundation Platform**, a skill-development programmes and protected foundation administration application.

## Scope

The guidance covers routing, providers, public pages, admin modules and shared components. It applies to new features, maintenance changes and production operations.
