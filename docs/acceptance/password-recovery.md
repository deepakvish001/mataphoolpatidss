# Password recovery acceptance specification

## Outcome

For Samarth Shakti Foundation Platform, users recover access without account enumeration.

## Primary scenario

**Given** an authorised or eligible user with valid input and an available service,

**When** the user completes the password recovery workflow,
