# Partner directory acceptance specification

## Outcome

For Samarth Shakti Foundation Platform, approved partners display accurate and accessible information.

## Primary scenario

**Given** an authorised or eligible user with valid input and an available service,

**When** the user completes the partner directory workflow,
