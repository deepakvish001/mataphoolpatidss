# Programme pages acceptance specification

## Outcome

For Samarth Shakti Foundation Platform, course and scheme details expose eligibility, dates and contacts.

## Primary scenario

**Given** an authorised or eligible user with valid input and an available service,

**When** the user completes the programme pages workflow,
