# Contact workflow acceptance specification

## Outcome

For Samarth Shakti Foundation Platform, validated enquiries submit once and expose clear recovery states.

## Primary scenario

**Given** an authorised or eligible user with valid input and an available service,

**When** the user completes the contact workflow workflow,
