# Admin authorization acceptance specification

## Outcome

For Samarth Shakti Foundation Platform, protected routes and database operations enforce roles.

## Primary scenario

**Given** an authorised or eligible user with valid input and an available service,

**When** the user completes the admin authorization workflow,
