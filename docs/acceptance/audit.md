# Administrative audit acceptance specification

## Outcome

For Samarth Shakti Foundation Platform, sensitive changes record actor, action, record and timestamp.

## Primary scenario

**Given** an authorised or eligible user with valid input and an available service,

**When** the user completes the administrative audit workflow,
