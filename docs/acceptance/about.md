# Organisation information acceptance specification

## Outcome

For Samarth Shakti Foundation Platform, published mission, leadership and governance content is accurate.

## Primary scenario

**Given** an authorised or eligible user with valid input and an available service,

**When** the user completes the organisation information workflow,
