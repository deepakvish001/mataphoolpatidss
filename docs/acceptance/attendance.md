# Attendance management acceptance specification

## Outcome

For Samarth Shakti Foundation Platform, records remain bounded, traceable and correctly calculated.

## Primary scenario

**Given** an authorised or eligible user with valid input and an available service,

**When** the user completes the attendance management workflow,
