# Administrative reports acceptance specification

## Outcome

For Samarth Shakti Foundation Platform, authorised exports are constrained and spreadsheet-safe.

## Primary scenario

**Given** an authorised or eligible user with valid input and an available service,

**When** the user completes the administrative reports workflow,
