# Administrator authentication acceptance specification

## Outcome

For Samarth Shakti Foundation Platform, authorised staff can sign in, restore sessions and sign out.

## Primary scenario

**Given** an authorised or eligible user with valid input and an available service,

**When** the user completes the administrator authentication workflow,
