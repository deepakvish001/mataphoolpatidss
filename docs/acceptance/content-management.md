# Content management acceptance specification

## Outcome

For Samarth Shakti Foundation Platform, draft, publish, edit and archive actions preserve validation.

## Primary scenario

**Given** an authorised or eligible user with valid input and an available service,

**When** the user completes the content management workflow,
