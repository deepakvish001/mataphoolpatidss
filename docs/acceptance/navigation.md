# Public navigation acceptance specification

## Outcome

For Samarth Shakti Foundation Platform, keyboard and mobile users can reach every public section.

## Primary scenario

**Given** an authorised or eligible user with valid input and an available service,

**When** the user completes the public navigation workflow,
