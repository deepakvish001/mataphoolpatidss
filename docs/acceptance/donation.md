# Donation workflow acceptance specification

## Outcome

For Samarth Shakti Foundation Platform, amounts, references, consent and failure states are handled safely.

## Primary scenario

**Given** an authorised or eligible user with valid input and an available service,

**When** the user completes the donation workflow workflow,
